# global construction environment used for the Development
Import("env")
...
def after_buildprog(source, target, env):
    ...
    print("SOURCES:", map(str, source))  # ['.pio/build/lpc11u35/firmware.bin']

    add_checksum(".pio/build/lpc11u35/firmware.bin")
